    ...
    return (
        <>
            <Container>
                <Row>
                    <Col md={12}>
                        <Navbar expand="lg" className="bg-white text-black rounded-pill my-5 px-3">
                                        ...
                                        <NavDropdown className='bg-white text-black' title="Dropdown" id="basic-nav-dropdown">
                                            ...
                                            <Dropdown className='bg-white'>
                                                ...
                                                <Dropdown.Menu>
                                                    ...
                                                    <Dropdown.Item href="#/action-4">Dropdown 4</Dropdown.Item>
                                                    <Dropdown.Item href="#/action-5">Dropdown 5</Dropdown.Item>
                                                </Dropdown.Menu>
                                            </Dropdown>
